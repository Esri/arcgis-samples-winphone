...
{
    public partial class ShowMapProperties : PhoneApplicationPage
    {
        ...
        {
            MapProperties.Visibility = MapProperties.Visibility == Visibility.Visible ? Visibility.Collapsed : Visibility.Visible;
        }
