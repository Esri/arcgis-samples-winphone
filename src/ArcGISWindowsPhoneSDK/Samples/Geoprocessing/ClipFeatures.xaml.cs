...
{
    public partial class ClipFeatures : PhoneApplicationPage
    {
        ...
        private void MyDrawObject_DrawComplete(object sender, DrawEventArgs args)
        {
            ...
            Geoprocessor geoprocessorTask = new Geoprocessor("http://serverapps10.esri.com/ArcGIS/rest/services/SamplesNET/USA_Data_ClipTools/GPServer/ClipCounties");
        ...
        {
            if (infoGrid.Visibility == System.Windows.Visibility.Collapsed)
