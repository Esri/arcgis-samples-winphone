...
{
    public partial class IdentityManagerServices : PhoneApplicationPage
    {
        ...
        {
            LegendBorder.Visibility = LegendBorder.Visibility == Visibility.Collapsed ? Visibility.Visible : Visibility.Collapsed;
        }
